  ...
  return (
    <>
      ...
      <section className="what-we-do-section" style={{
        ...
        <div className="what-we-do-container" style={{
          display: 'flex',
          alignItems: 'center',
          ...
          <div className="text-content" style={{ flex: '1 1 600px', textAlign: 'left' }}>
            <h2 style={{ fontSize: '2rem', fontWeight: 'bold', marginBottom: '20px' }}>
              What We Do?
            </h2>
            <p style={{ fontSize: '1.05rem', fontWeight: 'bold', lineHeight: '1.6' }}>
              <strong>Validify</strong> verifies the legitimacy of online businesses by collecting and reviewing their legal documents — whether they operate on Instagram, Facebook, or independent shopping websites.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="section3-content">
          <div className="section3-text">
            ...
            <div className="feature-block">
              ...
              <p>Whether it’s an Instagram shop, a Facebook seller, or a personal website, Validify helps you know who to trust.</p>
            </div>
            <div className="feature-block">
              <h3>Real User Reviews</h3>
              <h4>See what actual customers are saying.</h4>
              <p>Validify gathers and displays genuine reviews from people who have interacted with the business — helping you make informed decisions before you buy.</p>
            </div>
          </div>
